...
set Interfaces {
    s_axi_CTRL {
        ...
        memories "rcCmdIn {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_OBJ_AVD {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_OBJ_AVD"
        param_prefix "C_S_AXI_OBJ_AVD"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "obj_avd_cmd {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_OBJ_AVD m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 22 II 9}
