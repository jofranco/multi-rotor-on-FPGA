...
xilinx.com:hls:RC_RECEIVER:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins RC_RECEIVER_0/s_axi_CTRL] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins RC_RECEIVER_0/s_axi_TEST_CHAN] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins RC_RECEIVER_0/s_axi_TEST_NORM] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins RC_RECEIVER_0/s_axi_TEST_REV] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]

  # Create port connections
  connect_bd_net -net axi_uart16550_0_sout [get_bd_pins axi_uart16550_0/sout] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_UART_DRIVER_0/ap_clk] [get_bd_pins RC_RECEIVER_0/ap_clk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/S01_ACLK] [get_bd_pins ps7_0_axi_periph/S02_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_OUT_r] [get_bd_addr_segs RC_RECEIVER_0/s_axi_CTRL/Reg] SEG_RC_RECEIVER_0_Reg1
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_RECEIVER_0/s_axi_CTRL/Reg] SEG_RC_RECEIVER_0_Reg
  create_bd_addr_seg -range 0x00004000 -offset 0x40024000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_CHAN/Reg] SEG_RC_RECEIVER_0_Reg1
  create_bd_addr_seg -range 0x00004000 -offset 0x40004000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_NORM/Reg] SEG_RC_RECEIVER_0_Reg2
  create_bd_addr_seg -range 0x00004000 -offset 0x40014000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_REV/Reg] SEG_RC_RECEIVER_0_Reg3
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x40024000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_OUT_r] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_CHAN/Reg] SEG_RC_RECEIVER_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_OUT_r/SEG_RC_RECEIVER_0_Reg]

  create_bd_addr_seg -range 0x00004000 -offset 0x40004000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_OUT_r] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_NORM/Reg] SEG_RC_RECEIVER_0_Reg2
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_OUT_r/SEG_RC_RECEIVER_0_Reg2]

  create_bd_addr_seg -range 0x00004000 -offset 0x40014000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_OUT_r] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_REV/Reg] SEG_RC_RECEIVER_0_Reg4
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_UART] [get_bd_addr_segs RC_RECEIVER_0/s_axi_CTRL/Reg] SEG_RC_RECEIVER_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_UART/SEG_RC_RECEIVER_0_Reg]

  create_bd_addr_seg -range 0x00004000 -offset 0x40004000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_UART] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_NORM/Reg] SEG_RC_RECEIVER_0_Reg1
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_UART/SEG_RC_RECEIVER_0_Reg1]

  create_bd_addr_seg -range 0x00004000 -offset 0x40024000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_UART] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_CHAN/Reg] SEG_RC_RECEIVER_0_Reg2
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_UART/SEG_RC_RECEIVER_0_Reg2]

  create_bd_addr_seg -range 0x00004000 -offset 0x40014000 [get_bd_addr_spaces AXI_UART_DRIVER_0/Data_m_axi_UART] [get_bd_addr_segs RC_RECEIVER_0/s_axi_TEST_REV/Reg] SEG_RC_RECEIVER_0_Reg3
  exclude_bd_addr_seg [get_bd_addr_segs AXI_UART_DRIVER_0/Data_m_axi_UART/SEG_RC_RECEIVER_0_Reg3]
