...
set C_modelArgMapList {[ 
	{ "Name" : "UART", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "uart_bus","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	{ "Name" : "OUT_r", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "SBUS_data","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} ]}
...
set ArgLastReadFirstWriteLatency {
	AXI_UART_DRIVER {
		UART {Type IO LastRead 72 FirstWrite 1}
		OUT_r {Type IO LastRead 74 FirstWrite 43}
