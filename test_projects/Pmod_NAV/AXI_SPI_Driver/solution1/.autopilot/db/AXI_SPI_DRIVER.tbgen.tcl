set C_TypeInfoList {{ 
"AXI_SPI_DRIVER" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"spi_bus": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "OUT_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "spi_bus","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"AXI_SPI_DRIVER","role":"start","value":"0","valid_bit":"0"},{"name":"AXI_SPI_DRIVER","role":"continue","value":"0","valid_bit":"4"},{"name":"AXI_SPI_DRIVER","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "CTRL", "role": "ARADDR" },"address":[{"name":"AXI_SPI_DRIVER","role":"start","value":"0","valid_bit":"0"},{"name":"AXI_SPI_DRIVER","role":"done","value":"0","valid_bit":"1"},{"name":"AXI_SPI_DRIVER","role":"idle","value":"0","valid_bit":"2"},{"name":"AXI_SPI_DRIVER","role":"ready","value":"0","valid_bit":"3"},{"name":"AXI_SPI_DRIVER","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	AXI_SPI_DRIVER {
		OUT_r {Type O LastRead 6 FirstWrite 1}
