...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_1_FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000" *) input clk;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe37(net_slot_1_axi_arcache),
        .probe38(net_slot_1_axi_arlen),
        .probe39(net_slot_1_axi_arlock),
        .probe4(net_slot_0_axi_arid),
        .probe40(net_slot_1_axi_arprot),
        .probe41(net_slot_1_axi_arqos),
        .probe42(net_slot_1_axi_arregion),
        .probe43(net_slot_1_axi_arsize),
        .probe44(net_slot_1_axi_aw_cnt),
        .probe45(net_slot_1_axi_awaddr),
        .probe46(net_slot_1_axi_awcache),
        .probe47(net_slot_1_axi_awlen),
        .probe48(net_slot_1_axi_awlock),
        .probe49(net_slot_1_axi_awprot),
        .probe5(net_slot_0_axi_arlen),
        .probe50(net_slot_1_axi_awqos),
        .probe51(net_slot_1_axi_awregion),
        .probe52(net_slot_1_axi_awsize),
        .probe53(net_slot_1_axi_b_cnt),
        .probe54(net_slot_1_axi_bresp),
        .probe55(net_slot_1_axi_r_cnt),
        .probe56(net_slot_1_axi_rdata),
        .probe57(net_slot_1_axi_rresp),
        .probe58(net_slot_1_axi_wdata),
        .probe59(net_slot_1_axi_wstrb),
        .probe6(net_slot_0_axi_arlock),
        .probe60(net_slot_1_axi_aw_ctrl),
        .probe61(net_slot_1_axi_w_ctrl),
        .probe62(net_slot_1_axi_b_ctrl),
        .probe63(net_slot_1_axi_ar_ctrl),
        .probe64(net_slot_1_axi_r_ctrl),
