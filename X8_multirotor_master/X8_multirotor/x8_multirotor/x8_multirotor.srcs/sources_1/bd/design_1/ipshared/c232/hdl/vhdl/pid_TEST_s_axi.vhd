...
architecture behave of pid_TEST_s_axi is
    ...
    component pid_TEST_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component pid_TEST_s_axi_ram;
...
end entity pid_TEST_s_axi_ram;

architecture behave of pid_TEST_s_axi_ram is
