...
architecture behave of pwm_TEST_s_axi is
    ...
    component pwm_TEST_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component pwm_TEST_s_axi_ram;
...
end entity pwm_TEST_s_axi_ram;

architecture behave of pwm_TEST_s_axi_ram is
