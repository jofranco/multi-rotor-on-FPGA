...
set Library     "hls"
set IPName      "rx_driver"
set Version     "1.0"
set DisplayName "Rx_driver"
set Revision    "1902242141"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL m_axi_AXI_UART m_axi_SBUS_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_AXI_UART {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_AXI_UART"
        data_width "32"
        param_prefix "C_M_AXI_AXI_UART"
    ...
    m_axi_SBUS_data {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_SBUS_data"
        data_width "32"
        param_prefix "C_M_AXI_SBUS_DATA"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 600024 II x}
