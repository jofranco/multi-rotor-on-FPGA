...
set Library     "hls"
set IPName      "positionCtrl"
set Version     "1.0"
set DisplayName "Positionctrl"
set Revision    "1905162212"
...
set Interfaces {
    s_axi_CTRL {
        ...
        memories "pmod_data {base_address 8192 range 8192}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    m_axi_CTRL {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_CTRL"
        data_width "32"
        param_prefix "C_M_AXI_CTRL"
