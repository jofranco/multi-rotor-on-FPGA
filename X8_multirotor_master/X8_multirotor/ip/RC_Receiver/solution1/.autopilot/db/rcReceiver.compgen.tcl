...
set out_width 22
set exp i0*i1+i2
set arg_lists {i0 {11 0 +} i1 {11 0 +} m {22 0 +} i2 {19 1 +} p {22 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler rcReceiver_OUT_r_m_axi
}
