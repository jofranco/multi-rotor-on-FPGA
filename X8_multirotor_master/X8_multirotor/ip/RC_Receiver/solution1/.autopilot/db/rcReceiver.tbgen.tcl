...
set RtlHierarchyInfo {[
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.rcReceiver_mul_39bkb_U1", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.rcReceiver_mul_39bkb_U2", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.rcReceiver_mul_39bkb_U3", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	rcReceiver {
		SBUS_data {Type I LastRead 11 FirstWrite -1}
		OUT_r {Type O LastRead 18 FirstWrite 11}
