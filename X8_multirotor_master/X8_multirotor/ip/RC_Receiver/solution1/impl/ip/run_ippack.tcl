...
set Interfaces {
    ...
    s_axi_TEST_SCALE {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_TEST_SCALE"
        param_prefix "C_S_AXI_TEST_SCALE"
        addr_bits "15"
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "channel_scaled_V {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_TEST_CHAN s_axi_TEST_NORM s_axi_TEST_SCALE"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 45 II 46}
