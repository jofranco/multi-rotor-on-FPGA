...
entity rcReceiver_TEST_s_axi is
generic (
...
end entity rcReceiver_TEST_s_axi;
...
architecture behave of rcReceiver_TEST_s_axi is
    ...
    component rcReceiver_TEST_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component rcReceiver_TEST_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_test_V
int_test_V : rcReceiver_TEST_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 4096,
     AWIDTH   => log2(4096))
...
entity rcReceiver_TEST_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity rcReceiver_TEST_s_axi_ram;

architecture behave of rcReceiver_TEST_s_axi_ram is
