...
#ifndef __rcReceiver_mac_mubkb__HH__
#define __rcReceiver_mac_mubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(rcReceiver_mac_mubkb) {
    ...
    SC_CTOR(rcReceiver_mac_mubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
