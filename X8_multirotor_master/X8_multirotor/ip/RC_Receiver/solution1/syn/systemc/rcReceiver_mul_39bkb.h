...
#ifndef __rcReceiver_mul_39bkb__HH__
#define __rcReceiver_mul_39bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rcReceiver_mul_39bkb) {
    ...
    SC_CTOR(rcReceiver_mul_39bkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
