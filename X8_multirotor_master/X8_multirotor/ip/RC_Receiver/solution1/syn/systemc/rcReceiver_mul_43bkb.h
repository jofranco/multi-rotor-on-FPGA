...
#ifndef __rcReceiver_mul_43bkb__HH__
#define __rcReceiver_mul_43bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rcReceiver_mul_43bkb) {
    ...
    SC_CTOR(rcReceiver_mul_43bkb):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
