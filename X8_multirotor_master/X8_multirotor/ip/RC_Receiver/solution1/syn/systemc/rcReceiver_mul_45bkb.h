...
#ifndef __rcReceiver_mul_45bkb__HH__
#define __rcReceiver_mul_45bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(rcReceiver_mul_45bkb) {
    ...
    SC_CTOR(rcReceiver_mul_45bkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
