...
#ifndef __RC_RECEIVER_mac_mbkb__HH__
#define __RC_RECEIVER_mac_mbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(RC_RECEIVER_mac_mbkb) {
    ...
    SC_CTOR(RC_RECEIVER_mac_mbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
