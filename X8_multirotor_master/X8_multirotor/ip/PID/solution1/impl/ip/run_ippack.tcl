...
set Interfaces {
    s_axi_CTRL {
        ...
        memories "kp_V {base_address 32 range 32} kd_V {base_address 64 range 16} ki_V {base_address 80 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_INPUT {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_INPUT"
        param_prefix "C_S_AXI_INPUT"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {}
        memories "cmdIn_V {base_address 16 range 16} measured_V {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_TEST {
        ...
        registers {}
        memories "test_V {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_INPUT s_axi_TEST m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 23 II 23}
