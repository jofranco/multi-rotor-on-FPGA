...
set Interfaces {
    s_axi_CTRL {
        ...
        memories "cmdIn_V {base_address 16 range 16} measured_V {base_address 32 range 16} kp_V {base_address 64 range 32} kd_V {base_address 96 range 16} ki_V {base_address 112 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_TEST m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 26 II 22}
