...
set Interfaces {
    s_axi_CMD {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_CMD"
        param_prefix "C_S_AXI_CMD"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "rcCmdIn {base_address 16 range 8}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_GAINS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_GAINS"
        param_prefix "C_S_AXI_GAINS"
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {}
        memories "kp {base_address 16 range 16} kd {base_address 32 range 8} ki {base_address 40 range 8}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_MEAS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_MEAS"
        param_prefix "C_S_AXI_MEAS"
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {}
        memories "measured {base_address 16 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CMD s_axi_CTRL s_axi_GAINS s_axi_MEAS m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 36 II 5}
