...
#ifndef __pid_uitofp_32ns_3eOg__HH__
#define __pid_uitofp_32ns_3eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pid_uitofp_32ns_3eOg) {
    ...
    SC_CTOR(pid_uitofp_32ns_3eOg):  ACMP_uitofp_U ("ACMP_uitofp_U") {
