...
#ifndef __pid_mul_16ns_50s_bkb__HH__
#define __pid_mul_16ns_50s_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pid_mul_16ns_50s_bkb) {
    ...
    SC_CTOR(pid_mul_16ns_50s_bkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
