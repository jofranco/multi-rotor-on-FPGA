...
#ifndef __pid_sitofp_32s_32fYi__HH__
#define __pid_sitofp_32s_32fYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pid_sitofp_32s_32fYi) {
    ...
    SC_CTOR(pid_sitofp_32s_32fYi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
