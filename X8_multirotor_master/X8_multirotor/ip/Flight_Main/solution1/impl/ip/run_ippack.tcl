...
set Interfaces {
    s_axi_CMD {
        ...
        registers {}
        memories "rcCmdIn_V {base_address 16 range 16} obj_avd_cmd_V {base_address 32 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CMD s_axi_CTRL s_axi_TEST m_axi_OUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 24 II 18}
