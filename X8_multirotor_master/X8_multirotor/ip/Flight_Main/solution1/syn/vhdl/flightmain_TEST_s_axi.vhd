...
entity flightmain_TEST_s_axi is
generic (
...
architecture behave of flightmain_TEST_s_axi is
    ...
    end component flightmain_TEST_s_axi_ram;
...
entity flightmain_TEST_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity flightmain_TEST_s_axi_ram;

architecture behave of flightmain_TEST_s_axi_ram is
