...
entity flightmain_CMD_s_axi is
generic (
...
end entity flightmain_CMD_s_axi;
...
architecture behave of flightmain_CMD_s_axi is
    ...
    component flightmain_CMD_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component flightmain_CMD_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_rcCmdIn_V
int_rcCmdIn_V : flightmain_CMD_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
port map (
     ...
     q1       => int_rcCmdIn_V_q1);
-- int_obj_avd_cmd_V
int_obj_avd_cmd_V : flightmain_CMD_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 3,
     AWIDTH   => log2(3))
...
entity flightmain_CMD_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity flightmain_CMD_s_axi_ram;

architecture behave of flightmain_CMD_s_axi_ram is
