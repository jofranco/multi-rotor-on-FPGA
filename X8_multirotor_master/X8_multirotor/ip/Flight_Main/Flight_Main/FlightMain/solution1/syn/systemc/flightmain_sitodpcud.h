...
#ifndef __flightmain_sitodpcud__HH__
#define __flightmain_sitodpcud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(flightmain_sitodpcud) {
    ...
    SC_CTOR(flightmain_sitodpcud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
