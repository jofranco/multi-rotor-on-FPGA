...
port (
    ...
    measured_V_address0   :in   STD_LOGIC_VECTOR(1 downto 0);
    measured_V_ce0        :in   STD_LOGIC;
    measured_V_we0        :in   STD_LOGIC;
    measured_V_d0         :in   STD_LOGIC_VECTOR(15 downto 0);
...
architecture behave of flightmain_CTRL_s_axi is
    ...
    constant ADDR_OBJ_AVD_CMD_V_DATA_0  : INTEGER := 16#28#;
    constant ADDR_OBJ_AVD_CMD_V_CTRL    : INTEGER := 16#2c#;
    constant ADDR_HORIZON_CMD_V_DATA_0  : INTEGER := 16#30#;
    constant ADDR_HORIZON_CMD_V_CTRL    : INTEGER := 16#34#;
    constant ADDR_OBJ_AVD_FLAG_V_DATA_0 : INTEGER := 16#38#;
    constant ADDR_OBJ_AVD_FLAG_V_CTRL   : INTEGER := 16#3c#;
    ...
    constant ADDR_MEASURED_V_HIGH       : INTEGER := 16#27#;
    ...
    signal int_obj_avd_cmd_V   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_horizon_cmd_V   : UNSIGNED(15 downto 0) := (others => '0');
    signal int_obj_avd_flag_V  : UNSIGNED(15 downto 0) := (others => '0');
    -- memory signals
    ...
    signal int_measured_V_address0 : UNSIGNED(0 downto 0);
    ...
    signal int_measured_V_address1 : UNSIGNED(0 downto 0);
...
port map (
     ...
     q1       => int_rcCmdIn_V_q1);
-- int_measured_V
int_measured_V : flightmain_CTRL_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 2,
     AWIDTH   => log2(2))
...
-- ----------------------- AXI READ ----------------------
    ...
    RRESP   <= "00";  -- OKAY
    RVALID_t  <= '1' when (rstate = rddata) and (int_rcCmdIn_V_read = '0') and (int_measured_V_read = '0') else '0';
    RVALID    <= RVALID_t;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OBJ_AVD_CMD_V_DATA_0 =>
                        rdata_data <= RESIZE(int_obj_avd_cmd_V(15 downto 0), 32);
                    when ADDR_HORIZON_CMD_V_DATA_0 =>
                        rdata_data <= RESIZE(int_horizon_cmd_V(15 downto 0), 32);
                    when ADDR_OBJ_AVD_FLAG_V_DATA_0 =>
                        rdata_data <= RESIZE(int_obj_avd_flag_V(15 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
...
-- ----------------------- Register logic ----------------
    ...
    obj_avd_cmd_V        <= STD_LOGIC_VECTOR(int_obj_avd_cmd_V);
    horizon_cmd_V        <= STD_LOGIC_VECTOR(int_horizon_cmd_V);
    obj_avd_flag_V       <= STD_LOGIC_VECTOR(int_obj_avd_flag_V);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OBJ_AVD_CMD_V_DATA_0) then
                    int_obj_avd_cmd_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_obj_avd_cmd_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_HORIZON_CMD_V_DATA_0) then
                    int_horizon_cmd_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_horizon_cmd_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OBJ_AVD_FLAG_V_DATA_0) then
                    int_obj_avd_flag_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_obj_avd_flag_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
...
-- ----------------------- Memory logic ------------------
    ...
    int_rcCmdIn_V_we0    <= rcCmdIn_V_we0;
    int_rcCmdIn_V_be0    <= SHIFT_LEFT(TO_UNSIGNED(3, 4), TO_INTEGER(UNSIGNED(rcCmdIn_V_address0(0 downto 0)))*2);
    int_rcCmdIn_V_d0     <= UNSIGNED(rcCmdIn_V_d0) & UNSIGNED(rcCmdIn_V_d0);
    ...
    -- measured_V
    int_measured_V_address0 <= SHIFT_RIGHT(UNSIGNED(measured_V_address0), 1)(0 downto 0);
    int_measured_V_ce0   <= measured_V_ce0;
    int_measured_V_we0   <= measured_V_we0;
    int_measured_V_be0   <= SHIFT_LEFT(TO_UNSIGNED(3, 4), TO_INTEGER(UNSIGNED(measured_V_address0(0 downto 0)))*2);
    int_measured_V_d0    <= UNSIGNED(measured_V_d0) & UNSIGNED(measured_V_d0);
    int_measured_V_address1 <= raddr(2 downto 2) when ar_hs = '1' else waddr(2 downto 2);
