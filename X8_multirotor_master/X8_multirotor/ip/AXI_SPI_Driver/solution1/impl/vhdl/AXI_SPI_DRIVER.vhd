...
architecture behav of AXI_SPI_DRIVER is 
    ...
    "AXI_SPI_DRIVER,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=10,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=808,HLS_SYN_LUT=1028,HLS_VERSION=2018_2}";
    ...
    signal TX_message_address0 : STD_LOGIC_VECTOR (0 downto 0);
    signal TX_message_ce0 : STD_LOGIC;
    signal TX_message_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal RX_message_address0 : STD_LOGIC_VECTOR (0 downto 0);
    signal RX_message_ce0 : STD_LOGIC;
    signal RX_message_we0 : STD_LOGIC;
    ...
    signal state_load_reg_225 : STD_LOGIC_VECTOR (3 downto 0);
    signal TX_message_load_reg_241 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_ioackin_OUT_r_ARREADY : STD_LOGIC;
    signal OUT_addr_1_read_reg_258 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    port (
        ...
        TX_message_address0 : IN STD_LOGIC_VECTOR (0 downto 0);
        TX_message_ce0 : IN STD_LOGIC;
        TX_message_q0 : OUT STD_LOGIC_VECTOR (31 downto 0);
        RX_message_address0 : IN STD_LOGIC_VECTOR (0 downto 0);
        RX_message_ce0 : IN STD_LOGIC;
        RX_message_we0 : IN STD_LOGIC;
        RX_message_d0 : IN STD_LOGIC_VECTOR (31 downto 0) );
    end component;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_1)) or (not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_0)) or ((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
                    ap_reg_ioackin_OUT_r_AWREADY <= ap_const_logic_0;
                elsif ((((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = OUT_r_AWREADY) and (state = ap_const_lv4_1)) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_const_logic_1 = OUT_r_AWREADY) and (state = ap_const_lv4_0)) or ((ap_const_logic_1 = OUT_r_AWREADY) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state15)) or ((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
                    ap_reg_ioackin_OUT_r_WREADY <= ap_const_logic_0;
                elsif ((((ap_const_logic_1 = OUT_r_WREADY) and (ap_const_logic_1 = ap_CS_fsm_state15)) or ((ap_const_logic_1 = OUT_r_WREADY) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_const_logic_1 = OUT_r_WREADY) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = OUT_r_RVALID) and (ap_const_logic_1 = ap_CS_fsm_state28))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state14))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    state_load_reg_225(1 downto 0) <= state(1 downto 0);
            end if;
        end if;
    end process;
    state(3 downto 2) <= "00";
    state_load_reg_225(3 downto 2) <= "00";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, state, ap_CS_fsm_state8, ap_CS_fsm_state13, ap_CS_fsm_state2, ap_CS_fsm_state7, ap_CS_fsm_state14, ap_CS_fsm_state15, ap_CS_fsm_state20, ap_CS_fsm_state21, ap_CS_fsm_state28, OUT_r_RVALID, OUT_r_BVALID, ap_sig_ioackin_OUT_r_AWREADY, ap_block_state1_io, ap_sig_ioackin_OUT_r_ARREADY, ap_sig_ioackin_OUT_r_WREADY)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and not((state = ap_const_lv4_1)) and not((state = ap_const_lv4_0)) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state14;
                elsif ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                elsif ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_1))) then
            ...
            when ap_ST_fsm_state7 => 
                if (((ap_const_logic_1 = OUT_r_BVALID) and (ap_const_logic_1 = ap_CS_fsm_state7))) then
            ...
            when ap_ST_fsm_state15 => 
                if (((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state15))) then
            ...
            when ap_ST_fsm_state20 => 
                if (((ap_const_logic_1 = OUT_r_BVALID) and (ap_const_logic_1 = ap_CS_fsm_state20))) then
                    ap_NS_fsm <= ap_ST_fsm_state21;
                else
                    ap_NS_fsm <= ap_ST_fsm_state20;
                end if;
            when ap_ST_fsm_state21 => 
                if (((ap_sig_ioackin_OUT_r_ARREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state21))) then
    ...
    OUT_r_ARADDR <= ap_const_lv64_1B(32 - 1 downto 0);

    OUT_r_ARVALID_assign_proc : process(ap_CS_fsm_state21, ap_reg_ioackin_OUT_r_ARREADY)
    begin
        if (((ap_reg_ioackin_OUT_r_ARREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state21))) then 
    ...
    OUT_r_AWADDR_assign_proc : process(ap_CS_fsm_state14, ap_reg_ioackin_OUT_r_AWREADY, ap_condition_136, ap_condition_120)
    begin
    ...
    OUT_r_AWVALID_assign_proc : process(ap_start, ap_CS_fsm_state1, state, ap_CS_fsm_state14, ap_reg_ioackin_OUT_r_AWREADY)
    begin
        if ((((ap_start = ap_const_logic_1) and (ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_1)) or ((ap_start = ap_const_logic_1) and (ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_0)) or ((ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state14)))) then 
    ...
    OUT_r_BREADY_assign_proc : process(ap_CS_fsm_state13, ap_CS_fsm_state7, ap_CS_fsm_state20, OUT_r_BVALID)
    begin
        if ((((ap_const_logic_1 = OUT_r_BVALID) and (ap_const_logic_1 = ap_CS_fsm_state20)) or ((ap_const_logic_1 = OUT_r_BVALID) and (ap_const_logic_1 = ap_CS_fsm_state7)) or ((ap_const_logic_1 = OUT_r_BVALID) and (ap_const_logic_1 = ap_CS_fsm_state13)))) then 
    ...
    OUT_r_RREADY_assign_proc : process(ap_CS_fsm_state28, OUT_r_RVALID)
    begin
        if (((ap_const_logic_1 = OUT_r_RVALID) and (ap_const_logic_1 = ap_CS_fsm_state28))) then 
    ...
    OUT_r_WDATA_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state15, TX_message_load_reg_241, ap_reg_ioackin_OUT_r_WREADY)
    begin
    ...
    OUT_r_WVALID_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state15, ap_reg_ioackin_OUT_r_WREADY)
    begin
        if ((((ap_reg_ioackin_OUT_r_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state15)) or ((ap_reg_ioackin_OUT_r_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_reg_ioackin_OUT_r_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    OUT_r_blk_n_AR_assign_proc : process(m_axi_OUT_r_ARREADY, ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    OUT_r_blk_n_AW_assign_proc : process(ap_start, ap_CS_fsm_state1, m_axi_OUT_r_AWREADY, state, ap_CS_fsm_state14)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state14) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_1)) or ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_0)))) then 
    ...
    OUT_r_blk_n_B_assign_proc : process(m_axi_OUT_r_BVALID, ap_CS_fsm_state13, ap_CS_fsm_state7, ap_CS_fsm_state20)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state20) or (ap_const_logic_1 = ap_CS_fsm_state7) or (ap_const_logic_1 = ap_CS_fsm_state13))) then 
    ...
    OUT_r_blk_n_R_assign_proc : process(m_axi_OUT_r_RVALID, ap_CS_fsm_state28)
    begin
    ...
    OUT_r_blk_n_W_assign_proc : process(m_axi_OUT_r_WREADY, ap_CS_fsm_state8, ap_CS_fsm_state2, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    RX_message_address0 <= ap_const_lv64_0(1 - 1 downto 0);

    RX_message_ce0_assign_proc : process(ap_CS_fsm_state29)
    begin
    ...
    RX_message_we0_assign_proc : process(state_load_reg_225, ap_CS_fsm_state29)
    begin
        if ((not((state_load_reg_225 = ap_const_lv4_1)) and not((state_load_reg_225 = ap_const_lv4_0)) and (ap_const_logic_1 = ap_CS_fsm_state29))) then 
    ...
    TX_message_address0 <= ap_const_lv64_0(1 - 1 downto 0);

    TX_message_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_block_state1_io)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
                ap_block_state1_io <= (((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (state = ap_const_lv4_1)) or ((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (state = ap_const_lv4_0)));
    end process;


    ap_condition_120_assign_proc : process(ap_start, ap_CS_fsm_state1, state)
    begin
                ap_condition_120 <= ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_0));
    end process;


    ap_condition_136_assign_proc : process(ap_start, ap_CS_fsm_state1, state)
    begin
                ap_condition_136 <= ((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state = ap_const_lv4_1));
    end process;


    ap_condition_305_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_block_state1_io)
    begin
                ap_condition_305 <= (not(((ap_const_boolean_1 = ap_block_state1_io) or (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1));
    end process;
