...
if {[file isfile AXI_SPI_DRIVER.autotvin.dat]} {
	file delete -force AXI_SPI_DRIVER.autotvin.dat
}

if {[file isfile AXI_SPI_DRIVER.autotvout.dat]} {
	file delete -force AXI_SPI_DRIVER.autotvout.dat
}
