...
set C_modelArgList {
	...
	{ SBUS_data int 32 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "UART", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "uart_bus","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}]} , 
 	{ "Name" : "SBUS_data", "interface" : "axi_slave", "bundle":"TEST","type":"ap_memory","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "SBUS_data","cData": "unsigned int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4095,"step" : 1}]}]}], "offset" : {"out":16384}, "offset_end" : {"out":32767}} ]}
...
set NewPortList {[ 
	...
	{ "name": "s_axi_TEST_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "TEST", "role": "ARADDR" },"address":[{"name":"SBUS_data","role":"data","value":"16384"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "500003", "EstimateLatencyMax" : "500054",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "SBUS_data", "Type" : "Memory", "Direction" : "O"},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AXI_UART_DRIVER_TEST_s_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AXI_UART_DRIVER_UART_m_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	AXI_UART_DRIVER {
		UART {Type IO LastRead 49 FirstWrite 1}
		SBUS_data {Type O LastRead -1 FirstWrite 34}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "500003", "Max" : "500054"}
	, {"Name" : "Interval", "Min" : "500004", "Max" : "500055"}
]}
