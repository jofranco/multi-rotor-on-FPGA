...
set Library     "hls"
set IPName      "AXI_UART_DRIVER"
set Version     "1.0"
set DisplayName "Axi_uart_driver"
set Revision    "1905182026"
...
set Interfaces {
    ...
    s_axi_TEST {
        ...
        registers {}
        memories "SBUS_data {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_TEST m_axi_UART"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_UART {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_UART"
        data_width "32"
        param_prefix "C_M_AXI_UART"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 500003 II x}
