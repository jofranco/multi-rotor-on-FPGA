...
#ifndef __pwm_mul_mul_16s_1bkb__HH__
#define __pwm_mul_mul_16s_1bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pwm_mul_mul_16s_1bkb) {
    ...
    SC_CTOR(pwm_mul_mul_16s_1bkb):  ACMP_smul_su_U ("ACMP_smul_su_U") {
