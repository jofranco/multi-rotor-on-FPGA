...
set Interfaces {
    ...
    s_axi_TEST {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_TEST"
        param_prefix "C_S_AXI_TEST"
        addr_bits "15"
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "test {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    s_axi_TEST2 {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_TEST2"
        param_prefix "C_S_AXI_TEST2"
        addr_bits "15"
        port_width "AWADDR 15 WDATA 32 WSTRB 4 ARADDR 15 RDATA 32"
        registers {}
        memories "test2_V {base_address 16384 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL s_axi_TEST s_axi_TEST2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 11 II 11}
