        ...
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_MIN_DUTY_DATA_0: begin
                    rdata <= int_min_duty[31:0];
                end
                ADDR_MAX_DUTY_DATA_0: begin
                    rdata <= int_max_duty[31:0];
                end
                ADDR_PERIOD_DATA_0: begin
                    rdata <= int_period[31:0];
                end
            endcase
        end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MIN_DUTY_DATA_0)
            int_min_duty[31:0] <= (WDATA[31:0] & wmask) | (int_min_duty[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MAX_DUTY_DATA_0)
            int_max_duty[31:0] <= (WDATA[31:0] & wmask) | (int_max_duty[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_PERIOD_DATA_0)
            int_period[31:0] <= (WDATA[31:0] & wmask) | (int_period[31:0] & ~wmask);
    end
end
