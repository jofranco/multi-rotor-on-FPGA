...
set C_modelArgList {
	...
	{ spi_bus int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "OUT_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "spi_bus","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "spi_bus","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 999,"step" : 1}]}]}]} , 
 	{ "Name" : "spi_bus", "interface" : "axi_slave", "bundle":"CTRL","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			...
			{"Name" : "spi_bus", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	AXI_SPI_DRIVER {
		OUT_r {Type O LastRead 7 FirstWrite 2}
		spi_bus {Type I LastRead 0 FirstWrite -1}
