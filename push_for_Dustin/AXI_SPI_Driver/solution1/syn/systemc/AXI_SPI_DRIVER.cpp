...
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state1 = "1";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state2 = "10";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state3 = "100";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state4 = "1000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state5 = "10000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state6 = "100000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state7 = "1000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state8 = "10000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state9 = "100000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state10 = "1000000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state11 = "10000000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state12 = "100000000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state13 = "1000000000000";
const sc_lv<14> AXI_SPI_DRIVER::ap_ST_fsm_state14 = "10000000000000";
...
const sc_lv<32> AXI_SPI_DRIVER::ap_const_lv32_8 = "1000";
const sc_lv<32> AXI_SPI_DRIVER::ap_const_lv32_9 = "1001";
...
const sc_lv<32> AXI_SPI_DRIVER::ap_const_lv32_1F = "11111";
const sc_lv<31> AXI_SPI_DRIVER::ap_const_lv31_1C = "11100";
const sc_lv<31> AXI_SPI_DRIVER::ap_const_lv31_18 = "11000";
...
AXI_SPI_DRIVER::AXI_SPI_DRIVER(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    AXI_SPI_DRIVER_CTRL_s_axi_U->spi_bus(spi_bus);
    ...
    sensitive << ( spi_bus2_sum_cast_fu_158_p1 );
    sensitive << ( spi_bus2_sum3_cast_fu_168_p1 );
    ...
    SC_METHOD(thread_spi_bus2_sum3_cast_fu_168_p1);
    sensitive << ( spi_bus2_sum3_reg_187 );

    SC_METHOD(thread_spi_bus2_sum3_fu_146_p2);
    sensitive << ( tmp_cast_fu_126_p1 );

    SC_METHOD(thread_spi_bus2_sum_cast_fu_158_p1);
    sensitive << ( spi_bus2_sum_reg_182 );

    SC_METHOD(thread_spi_bus2_sum_fu_134_p2);
    sensitive << ( tmp_cast_fu_126_p1 );
    ...
    sc_trace(mVcdFile, spi_bus, "spi_bus");
    ...
    sc_trace(mVcdFile, state_load_reg_178, "state_load_reg_178");
    ...
    sc_trace(mVcdFile, spi_bus2_sum_fu_134_p2, "spi_bus2_sum_fu_134_p2");
    sc_trace(mVcdFile, spi_bus2_sum_reg_182, "spi_bus2_sum_reg_182");
    sc_trace(mVcdFile, spi_bus2_sum3_fu_146_p2, "spi_bus2_sum3_fu_146_p2");
    sc_trace(mVcdFile, spi_bus2_sum3_reg_187, "spi_bus2_sum3_reg_187");
    sc_trace(mVcdFile, ap_sig_ioackin_OUT_r_AWREADY, "ap_sig_ioackin_OUT_r_AWREADY");
    sc_trace(mVcdFile, spi_bus2_sum_cast_fu_158_p1, "spi_bus2_sum_cast_fu_158_p1");
    sc_trace(mVcdFile, spi_bus2_sum3_cast_fu_168_p1, "spi_bus2_sum3_cast_fu_168_p1");
...
void AXI_SPI_DRIVER::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
            if (esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_0)) {
                state = ap_const_lv4_1;
            } else if (esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_1)) {
                state = ap_const_lv4_2;
            }
        }
    }
    if ((esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_0) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        spi_bus2_sum3_reg_187 = spi_bus2_sum3_fu_146_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_1))) {
        spi_bus2_sum_reg_182 = spi_bus2_sum_fu_134_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        state_load_reg_178 = state.read();
    }
}
...
void AXI_SPI_DRIVER::thread_OUT_r_AWADDR() {
    if (esl_seteq<1,1,1>(ap_const_logic_0, ap_reg_ioackin_OUT_r_AWREADY.read())) {
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state9.read())) {
            OUT_r_AWADDR =  (sc_lv<32>) (spi_bus2_sum3_cast_fu_168_p1.read());
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
            OUT_r_AWADDR =  (sc_lv<32>) (spi_bus2_sum_cast_fu_158_p1.read());
        } else {
...
void AXI_SPI_DRIVER::thread_OUT_r_BREADY() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
          esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_1) && 
          !((esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read()) && 
  esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_1)) || (esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read())))) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && 
          esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_0) && 
          !((esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read()) && 
  esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_1)) || (esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read())))))) {
...
void AXI_SPI_DRIVER::thread_ap_CS_fsm_state10() {
...
void AXI_SPI_DRIVER::thread_ap_CS_fsm_state9() {
    ap_CS_fsm_state9 = ap_CS_fsm.read()[8];
}

void AXI_SPI_DRIVER::thread_ap_block_state8() {
    ap_block_state8 = ((esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read()) && 
  esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_1)) || (esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read())));
}
...
void AXI_SPI_DRIVER::thread_spi_bus2_sum3_cast_fu_168_p1() {
    spi_bus2_sum3_cast_fu_168_p1 = esl_zext<64,31>(spi_bus2_sum3_reg_187.read());
}

void AXI_SPI_DRIVER::thread_spi_bus2_sum3_fu_146_p2() {
    spi_bus2_sum3_fu_146_p2 = (!tmp_cast_fu_126_p1.read().is_01() || !ap_const_lv31_18.is_01())? sc_lv<31>(): (sc_biguint<31>(tmp_cast_fu_126_p1.read()) + sc_biguint<31>(ap_const_lv31_18));
}

void AXI_SPI_DRIVER::thread_spi_bus2_sum_cast_fu_158_p1() {
    spi_bus2_sum_cast_fu_158_p1 = esl_zext<64,31>(spi_bus2_sum_reg_182.read());
}

void AXI_SPI_DRIVER::thread_spi_bus2_sum_fu_134_p2() {
    spi_bus2_sum_fu_134_p2 = (!tmp_cast_fu_126_p1.read().is_01() || !ap_const_lv31_1C.is_01())? sc_lv<31>(): (sc_biguint<31>(tmp_cast_fu_126_p1.read()) + sc_biguint<31>(ap_const_lv31_1C));
}

void AXI_SPI_DRIVER::thread_state_load_load_fu_130_p1() {
    state_load_load_fu_130_p1 = state.read();
}

void AXI_SPI_DRIVER::thread_tmp_cast_fu_126_p1() {
    tmp_cast_fu_126_p1 = esl_zext<31,30>(tmp_fu_116_p4.read());
}

void AXI_SPI_DRIVER::thread_tmp_fu_116_p4() {
    tmp_fu_116_p4 = spi_bus.read().range(31, 2);
}
...
void AXI_SPI_DRIVER::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            } else if ((!esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_0) && !esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_1) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
                ap_NS_fsm = ap_ST_fsm_state8;
            } else if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,4,4>(state_load_load_fu_130_p1.read(), ap_const_lv4_1))) {
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_sig_ioackin_OUT_r_AWREADY.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_sig_ioackin_OUT_r_WREADY.read(), ap_const_logic_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()))) {
        ...
        case 128 : 
            if ((!((esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read()) && 
  esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_1)) || (esl_seteq<1,4,4>(state_load_reg_178.read(), ap_const_lv4_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, OUT_r_BVALID.read()))) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state8;
            }
