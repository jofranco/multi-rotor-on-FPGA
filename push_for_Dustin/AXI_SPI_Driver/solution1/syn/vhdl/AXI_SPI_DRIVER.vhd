...
architecture behav of AXI_SPI_DRIVER is 
    ...
    "AXI_SPI_DRIVER,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=5,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=668,HLS_SYN_LUT=908,HLS_VERSION=2018_2}";
    ...
    signal spi_bus : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal state_load_reg_178 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal state_load_load_fu_130_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal spi_bus2_sum_fu_134_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal spi_bus2_sum_reg_182 : STD_LOGIC_VECTOR (30 downto 0);
    signal spi_bus2_sum3_fu_146_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal spi_bus2_sum3_reg_187 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_sig_ioackin_OUT_r_AWREADY : STD_LOGIC;
    signal spi_bus2_sum_cast_fu_158_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal spi_bus2_sum3_cast_fu_168_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_fu_116_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_cast_fu_126_p1 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    port (
        ...
        spi_bus : OUT STD_LOGIC_VECTOR (31 downto 0) );
    end component;
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state9)) or ((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
                    ap_reg_ioackin_OUT_r_AWREADY <= ap_const_logic_0;
                elsif ((((ap_const_logic_1 = ap_CS_fsm_state9) and (ap_const_logic_1 = OUT_r_AWREADY)) or ((ap_const_logic_1 = OUT_r_AWREADY) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3)) or ((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
                    ap_reg_ioackin_OUT_r_WREADY <= ap_const_logic_0;
                elsif ((((ap_const_logic_1 = OUT_r_WREADY) and (ap_const_logic_1 = ap_CS_fsm_state3)) or ((ap_const_logic_1 = OUT_r_WREADY) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    if ((state_load_load_fu_130_p1 = ap_const_lv4_0)) then 
                        state(0) <= '1';
                        state(1) <= '0';
                    elsif ((state_load_load_fu_130_p1 = ap_const_lv4_1)) then 
                        state(0) <= '0';
                        state(1) <= '1';
                    end if;
                end if; 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((state_load_load_fu_130_p1 = ap_const_lv4_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state_load_load_fu_130_p1 = ap_const_lv4_1))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    state_load_reg_178(1 downto 0) <= state(1 downto 0);
            end if;
        end if;
    end process;
    state(3 downto 2) <= "00";
    state_load_reg_178(3 downto 2) <= "00";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state9, ap_CS_fsm_state10, ap_CS_fsm_state8, state_load_reg_178, ap_CS_fsm_state2, ap_CS_fsm_state3, OUT_r_BVALID, state_load_load_fu_130_p1, ap_sig_ioackin_OUT_r_AWREADY, ap_sig_ioackin_OUT_r_WREADY)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((state_load_load_fu_130_p1 = ap_const_lv4_0) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state9;
                elsif ((not((state_load_load_fu_130_p1 = ap_const_lv4_0)) and not((state_load_load_fu_130_p1 = ap_const_lv4_1)) and (ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                elsif (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1) and (state_load_load_fu_130_p1 = ap_const_lv4_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                else
                    ap_NS_fsm <= ap_ST_fsm_state1;
                end if;
            when ap_ST_fsm_state2 => 
                if (((ap_sig_ioackin_OUT_r_AWREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state3;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
            when ap_ST_fsm_state3 => 
                if (((ap_sig_ioackin_OUT_r_WREADY = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
            ...
            when ap_ST_fsm_state8 => 
                if ((not((((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state8;
                end if;
    ...
    OUT_r_AWADDR_assign_proc : process(ap_CS_fsm_state9, ap_CS_fsm_state2, spi_bus2_sum_cast_fu_158_p1, spi_bus2_sum3_cast_fu_168_p1, ap_reg_ioackin_OUT_r_AWREADY)
    begin
        if ((ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0)) then
            if ((ap_const_logic_1 = ap_CS_fsm_state9)) then 
                OUT_r_AWADDR <= spi_bus2_sum3_cast_fu_168_p1(32 - 1 downto 0);
            elsif ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                OUT_r_AWADDR <= spi_bus2_sum_cast_fu_158_p1(32 - 1 downto 0);
            else 
    ...
    OUT_r_AWVALID_assign_proc : process(ap_CS_fsm_state9, ap_CS_fsm_state2, ap_reg_ioackin_OUT_r_AWREADY)
    begin
        if ((((ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state9)) or ((ap_reg_ioackin_OUT_r_AWREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state2)))) then 
    ...
    OUT_r_BREADY_assign_proc : process(ap_CS_fsm_state8, state_load_reg_178, OUT_r_BVALID)
    begin
        if (((not((((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)))) and (ap_const_logic_1 = ap_CS_fsm_state8) and (state_load_reg_178 = ap_const_lv4_1)) or (not((((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)))) and (state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    OUT_r_WDATA_assign_proc : process(ap_CS_fsm_state10, ap_CS_fsm_state3, ap_reg_ioackin_OUT_r_WREADY)
    begin
    ...
    OUT_r_WVALID_assign_proc : process(ap_CS_fsm_state10, ap_CS_fsm_state3, ap_reg_ioackin_OUT_r_WREADY)
    begin
        if ((((ap_reg_ioackin_OUT_r_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state3)) or ((ap_reg_ioackin_OUT_r_WREADY = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state10)))) then 
    ...
    OUT_r_blk_n_AW_assign_proc : process(m_axi_OUT_r_AWREADY, ap_CS_fsm_state9, ap_CS_fsm_state2)
    begin
    ...
    OUT_r_blk_n_B_assign_proc : process(m_axi_OUT_r_BVALID, ap_CS_fsm_state8, state_load_reg_178)
    begin
        if ((((ap_const_logic_1 = ap_CS_fsm_state8) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    OUT_r_blk_n_W_assign_proc : process(m_axi_OUT_r_WREADY, ap_CS_fsm_state10, ap_CS_fsm_state3)
    begin
    ...
    ap_block_state8_assign_proc : process(state_load_reg_178, OUT_r_BVALID)
    begin
                ap_block_state8 <= (((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)));
    end process;


    ap_done_assign_proc : process(ap_CS_fsm_state8, state_load_reg_178, OUT_r_BVALID)
    begin
        if ((not((((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state8, state_load_reg_178, OUT_r_BVALID)
    begin
        if ((not((((ap_const_logic_0 = OUT_r_BVALID) and (state_load_reg_178 = ap_const_lv4_1)) or ((state_load_reg_178 = ap_const_lv4_0) and (ap_const_logic_0 = OUT_r_BVALID)))) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    spi_bus2_sum3_cast_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(spi_bus2_sum3_reg_187),64));
    spi_bus2_sum3_fu_146_p2 <= std_logic_vector(unsigned(tmp_cast_fu_126_p1) + unsigned(ap_const_lv31_18));
    spi_bus2_sum_cast_fu_158_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(spi_bus2_sum_reg_182),64));
    spi_bus2_sum_fu_134_p2 <= std_logic_vector(unsigned(tmp_cast_fu_126_p1) + unsigned(ap_const_lv31_1C));
    state_load_load_fu_130_p1 <= state;
    tmp_cast_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_116_p4),31));
    tmp_fu_116_p4 <= spi_bus(31 downto 2);
end behav;
