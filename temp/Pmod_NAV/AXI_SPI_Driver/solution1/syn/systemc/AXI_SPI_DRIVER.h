...
struct AXI_SPI_DRIVER : public sc_module {
    ...
    void thread_RX_message_V_ap_vld();
    ...
    void thread_ap_done();
    void thread_ap_idle();
    void thread_ap_predicate_op36_writereq_state1();
    void thread_ap_predicate_op48_writeresp_state7();
