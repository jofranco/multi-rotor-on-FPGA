...
entity AXI_SPI_DRIVER_debug_s_axi is
generic (
...
architecture behave of AXI_SPI_DRIVER_debug_s_axi is
    ...
    constant ADDR_TX_MESSAGE_V_DATA_0 : INTEGER := 16#10#;
    constant ADDR_TX_MESSAGE_V_CTRL   : INTEGER := 16#14#;
    constant ADDR_RX_MESSAGE_V_DATA_0 : INTEGER := 16#18#;
    constant ADDR_RX_MESSAGE_V_CTRL   : INTEGER := 16#1c#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TX_MESSAGE_V_DATA_0) then
                    int_TX_message_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_TX_message_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
