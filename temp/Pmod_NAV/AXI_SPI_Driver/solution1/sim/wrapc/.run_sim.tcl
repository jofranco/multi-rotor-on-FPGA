...
set ::env(PATH) "$::env(PATH);C:/CAD/Vivado/2018.2/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/CAD/Vivado/2018.2/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/CAD/Vivado/2018.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/CAD/Vivado/2018.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/CAD/Vivado/2018.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "AXI_SPI_DRIVER.autotvin.dat"
	set constFileTvOut       "AXI_SPI_DRIVER.autotvout.dat"
	set constFileHdlTvIn     "AXI_SPI_DRIVER.autohdltvin.dat"
	set constFileHdlTvOut    "AXI_SPI_DRIVER.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
