...
// Date        : Tue May 28 23:46:42 2019
// Host        : DESKTOP-9NGIUQU running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub
//               C:/Users/Aaron/Desktop/School/WES_Capstone/Jupyter_Demos/Flight_Main_PID_Test/Flight_Main_PID_Test.srcs/sources_1/bd/design_1/ip/design_1_pid_0_0/design_1_pid_0_0_stub.v
...
module design_1_pid_0_0(s_axi_CTRL_AWADDR, s_axi_CTRL_AWVALID, 
  s_axi_CTRL_AWREADY, s_axi_CTRL_WDATA, s_axi_CTRL_WSTRB, s_axi_CTRL_WVALID, 
  s_axi_CTRL_WREADY, s_axi_CTRL_BRESP, s_axi_CTRL_BVALID, s_axi_CTRL_BREADY, 
  s_axi_CTRL_ARADDR, s_axi_CTRL_ARVALID, s_axi_CTRL_ARREADY, s_axi_CTRL_RDATA, 
  s_axi_CTRL_RRESP, s_axi_CTRL_RVALID, s_axi_CTRL_RREADY, s_axi_INPUT_AWADDR, 
  s_axi_INPUT_AWVALID, s_axi_INPUT_AWREADY, s_axi_INPUT_WDATA, s_axi_INPUT_WSTRB, 
  s_axi_INPUT_WVALID, s_axi_INPUT_WREADY, s_axi_INPUT_BRESP, s_axi_INPUT_BVALID, 
  s_axi_INPUT_BREADY, s_axi_INPUT_ARADDR, s_axi_INPUT_ARVALID, s_axi_INPUT_ARREADY, 
  s_axi_INPUT_RDATA, s_axi_INPUT_RRESP, s_axi_INPUT_RVALID, s_axi_INPUT_RREADY, 
  ...
  s_axi_TEST_RREADY, ap_clk, ap_rst_n, interrupt, m_axi_OUT_r_AWADDR, m_axi_OUT_r_AWLEN, 
...
/* synthesis syn_black_box black_box_pad_pin="s_axi_CTRL_AWADDR[6:0],s_axi_CTRL_AWVALID,s_axi_CTRL_AWREADY,s_axi_CTRL_WDATA[31:0],s_axi_CTRL_WSTRB[3:0],s_axi_CTRL_WVALID,s_axi_CTRL_WREADY,s_axi_CTRL_BRESP[1:0],s_axi_CTRL_BVALID,s_axi_CTRL_BREADY,s_axi_CTRL_ARADDR[6:0],s_axi_CTRL_ARVALID,s_axi_CTRL_ARREADY,s_axi_CTRL_RDATA[31:0],s_axi_CTRL_RRESP[1:0],s_axi_CTRL_RVALID,s_axi_CTRL_RREADY,s_axi_INPUT_AWADDR[5:0],s_axi_INPUT_AWVALID,s_axi_INPUT_AWREADY,s_axi_INPUT_WDATA[31:0],s_axi_INPUT_WSTRB[3:0],s_axi_INPUT_WVALID,s_axi_INPUT_WREADY,s_axi_INPUT_BRESP[1:0],s_axi_INPUT_BVALID,s_axi_INPUT_BREADY,s_axi_INPUT_ARADDR[5:0],s_axi_INPUT_ARVALID,s_axi_INPUT_ARREADY,s_axi_INPUT_RDATA[31:0],s_axi_INPUT_RRESP[1:0],s_axi_INPUT_RVALID,s_axi_INPUT_RREADY,s_axi_TEST_AWADDR[14:0],s_axi_TEST_AWVALID,s_axi_TEST_AWREADY,s_axi_TEST_WDATA[31:0],s_axi_TEST_WSTRB[3:0],s_axi_TEST_WVALID,s_axi_TEST_WREADY,s_axi_TEST_BRESP[1:0],s_axi_TEST_BVALID,s_axi_TEST_BREADY,s_axi_TEST_ARADDR[14:0],s_axi_TEST_ARVALID,s_axi_TEST_ARREADY,s_axi_TEST_RDATA[31:0],s_axi_TEST_RRESP[1:0],s_axi_TEST_RVALID,s_axi_TEST_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_OUT_r_AWADDR[31:0],m_axi_OUT_r_AWLEN[7:0],m_axi_OUT_r_AWSIZE[2:0],m_axi_OUT_r_AWBURST[1:0],m_axi_OUT_r_AWLOCK[1:0],m_axi_OUT_r_AWREGION[3:0],m_axi_OUT_r_AWCACHE[3:0],m_axi_OUT_r_AWPROT[2:0],m_axi_OUT_r_AWQOS[3:0],m_axi_OUT_r_AWVALID,m_axi_OUT_r_AWREADY,m_axi_OUT_r_WDATA[31:0],m_axi_OUT_r_WSTRB[3:0],m_axi_OUT_r_WLAST,m_axi_OUT_r_WVALID,m_axi_OUT_r_WREADY,m_axi_OUT_r_BRESP[1:0],m_axi_OUT_r_BVALID,m_axi_OUT_r_BREADY,m_axi_OUT_r_ARADDR[31:0],m_axi_OUT_r_ARLEN[7:0],m_axi_OUT_r_ARSIZE[2:0],m_axi_OUT_r_ARBURST[1:0],m_axi_OUT_r_ARLOCK[1:0],m_axi_OUT_r_ARREGION[3:0],m_axi_OUT_r_ARCACHE[3:0],m_axi_OUT_r_ARPROT[2:0],m_axi_OUT_r_ARQOS[3:0],m_axi_OUT_r_ARVALID,m_axi_OUT_r_ARREADY,m_axi_OUT_r_RDATA[31:0],m_axi_OUT_r_RRESP[1:0],m_axi_OUT_r_RLAST,m_axi_OUT_r_RVALID,m_axi_OUT_r_RREADY" */;
  ...
  input [5:0]s_axi_INPUT_AWADDR;
  input s_axi_INPUT_AWVALID;
  output s_axi_INPUT_AWREADY;
  input [31:0]s_axi_INPUT_WDATA;
  input [3:0]s_axi_INPUT_WSTRB;
  ...
  input [5:0]s_axi_INPUT_ARADDR;
  input s_axi_INPUT_ARVALID;
  output s_axi_INPUT_ARREADY;
  output [31:0]s_axi_INPUT_RDATA;
