...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Op1_0_1 [get_bd_ports sin] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_uart16550_0/xin] [get_bd_pins processing_system7_0/FCLK_CLK1]
